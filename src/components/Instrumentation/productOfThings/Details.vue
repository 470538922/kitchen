      ...
      <div class="table_list">
        <el-form label-width="200px" size="small">
          ...
          <el-form-item label="LOGO：" prop>
            <span
              class="pic_style"
              @click="look(global.imgPath + oneProductMsg.logo.replace('img:', ''))"
            >{{oneProductMsg.logo1}}</span>
          </el-form-item>
    ...
    findOne(id) {
      this.Axios(
        ...
        if (result.data.code === 200) {
          ...
          this.oneProductMsg.logo1 = this.oneProductMsg.logo.substring(
            this.oneProductMsg.logo.lastIndexOf("/") + 1
          );
