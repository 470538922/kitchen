<template>
  <div class="cookbook_list">
    <div :class="[{hide:isHideList}]">
            ...
            <el-table-column label="操作" width="140">
              <template slot-scope="scope">
                ...
                <el-button
                  ...
                  type="text"
                  size="mini"
                  @click.stop.prevent="shoWerweima(scope.$index, scope.row)"
                >二维码</el-button>
              </template>
            </el-table-column>
          </el-table>
      ...
      <el-dialog :show-close="false" :visible.sync="erweimaVisible" class="showPic" width="400px">
      ...
      this.axios
        ...
        .then(res => {
          if (res.status == 200) {
            ...
            downloadElement.download = this.fileName + ".jpg"; //下载后文件名
